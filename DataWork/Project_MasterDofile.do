...
*iefolder*1*RoundGlobals*rounds*journey_to_jah*journey_to_jah*******************
*iefolder will not work properly if the line above is edited

   *journey_to_jah folder globals
...
*iefolder*3*RunDofiles*journey_to_jah*journey_to_jah****************************
*iefolder will not work properly if the line above is edited

   if (0) { //Change the 0 to 1 to run the journey_to_jah master dofile
       do "$journey_to_jah/journey_to_jah_MasterDofile.do" 
   }
